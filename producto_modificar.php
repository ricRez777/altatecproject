<?php 
		...
		$idProducto = $_POST['txtIdProductoModificar'];
	...
	<div class="container">
		<div class="form-group row">
			...
			<div class="col-md-8 form-registro">
				<form action="procesos/producto_editar.php" name="registroUsuario" method="POST" enctype="multipart/form-data">
					<br>
					<h1>Modificar producto: </h1>
					<br>
					<label class="col-sm-8 col-form-label">Nombre del articulo: </label>
					<div class="col-sm-11">
					<input type="text" required name="txtnombreProducto" 
					value="<?php echo $productos->getNombreProducto() ?>" 
					...
					<input type="text" class="idOculto" value="<?php echo $productos->getIdProducto()?>" name="txtIdProd">
					<br>
					<input type="submit" value="Modificar"name="btnModificar" class="btn btn-AltaTec">
					<br>
					<br>
				</form>
			</div>
